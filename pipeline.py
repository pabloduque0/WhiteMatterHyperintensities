...
utrecht_resized_t1 = parser.resize_slices(utrecht_data_t1, constant.SLICE_SHAPE)
...
singapore_resized_t1 = parser.resize_slices(singapore_data_t1, constant.SLICE_SHAPE)
...
amsterdam_resized_t1 = parser.resize_slices(amsterdam_data_t1, constant.SLICE_SHAPE)
...
utrecht_resized_flairs = parser.resize_slices(utrecht_data_flair, constant.SLICE_SHAPE)
...
singapore_resized_flairs = parser.resize_slices(singapore_data_flair, constant.SLICE_SHAPE)
...
amsterdam_resized_flairs = parser.resize_slices(amsterdam_data_flair, constant.SLICE_SHAPE)
...
resized_labels = parser.resize_slices(all_labels_imgs, constant.SLICE_SHAPE)
