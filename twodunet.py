...
from metrics import dice_coef, dice_coef_loss, weighted_crossentropy, predicted_count, ground_truth_count, label_count, label_sum
...
class TwoDUnet():
    ...
    def create_model(self, img_shape):
        ...
        model.compile(optimizer=Adam(lr=0.001), loss=binary_crossentropy, metrics=[dice_coef, binary_crossentropy, weighted_crossentropy,
                                                                                   predicted_count, ground_truth_count, label_count, label_sum])
