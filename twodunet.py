...
class TwoDUnet():
    ...
    def create_model(self, img_shape):
        ...
        conv2 = layers.Conv2D(64, kernel_size=3, padding='same', activation='relu')(conv1)
        maxpool1 = layers.MaxPool2D(pool_size=(2, 2))(conv2)

        conv3 = layers.Conv2D(128, kernel_size=3, padding='same', activation='relu')(maxpool1)
        conv4 = layers.Conv2D(128, kernel_size=3, padding='same', activation='relu')(conv3)
        maxpool2 = layers.MaxPool2D(pool_size=(2, 2))(conv4)

        conv5 = layers.Conv2D(256, kernel_size=3, padding='same', activation='relu')(maxpool2)
        conv6 = layers.Conv2D(256, kernel_size=3, padding='same', activation='relu')(conv5)
        maxpool3 = layers.MaxPool2D(pool_size=(2, 2))(conv6)

        conv7 = layers.Conv2D(512, kernel_size=3, padding='same', activation='relu')(maxpool3)
        conv8 = layers.Conv2D(512, kernel_size=3, padding='same', activation='relu')(conv7)
        maxpool4 = layers.MaxPool2D(pool_size=(2, 2))(conv8)

        conv9 = layers.Conv2D(1024, kernel_size=3, padding='same', activation='relu')(maxpool4)
        conv10 = layers.Conv2D(1024, kernel_size=3, padding='same', activation='relu')(conv9)
        ...
        conv11 = layers.Conv2D(512, kernel_size=2, padding='same', activation='relu')(up_samp1)

        conv12 = layers.Conv2D(512, kernel_size=3, padding='same', activation='relu')(conv11)
        conv13 = layers.Conv2D(512, kernel_size=3, padding='same', activation='relu')(conv12)
        ...
        conv14 = layers.Conv2D(256, kernel_size=3, padding='same', activation='relu')(up_samp2)

        conv15 = layers.Conv2D(256, kernel_size=3, padding='same', activation='relu')(conv14)
        conv16 = layers.Conv2D(256, kernel_size=3, padding='same', activation='relu')(conv15)
        ...
        conv17 = layers.Conv2D(128, kernel_size=3, padding='same', activation='relu')(up_samp3)

        conv18 = layers.Conv2D(128, kernel_size=3, padding='same', activation='relu')(conv17)
        conv19 = layers.Conv2D(128, kernel_size=3, padding='same', activation='relu')(conv18)
        ...
        conv20 = layers.Conv2D(64, kernel_size=3, padding='same', activation='relu')(up_samp1)

        conv21 = layers.Conv2D(64, kernel_size=3, padding='same', activation='relu')(conv20)
        conv22 = layers.Conv2D(64, kernel_size=3, padding='same', activation='relu')(conv21)

        conv23 = layers.Conv2D(1, kernel_size=1, padding='same', activation='softmax')(conv22)

        model = models.Model(inputs=inputs, outputs=conv23)

        model.compile(optimizer=Adam(lr=0.001), loss=binary_crossentropy, metrics=[dice_coef, binary_crossentropy])
